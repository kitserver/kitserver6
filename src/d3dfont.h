...
public:
    ...
    HRESULT DrawTextScaled( FLOAT x, FLOAT y, FLOAT z, 
                            ...
                            WCHAR* strText, DWORD dwFlags=0L );
    HRESULT Render3DText( WCHAR* strText, DWORD dwFlags=0L );
    
    // Function to get extent of text
    HRESULT GetTextExtent( WCHAR* strText, SIZE* pSize );
    ...
    CD3DFont( WCHAR* strFontName, DWORD dwHeight, DWORD dwFlags=0L );
    ~CD3DFont();
};
