...
//-----------------------------------------------------------------------------
CD3DFont::CD3DFont( WCHAR* strFontName, DWORD dwHeight, DWORD dwFlags )
{
    wcscpy( m_strFontName, strFontName );
...
HRESULT CD3DFont::InitDeviceObjects( LPDIRECT3DDEVICE8 pd3dDevice )
{
    ...
    if( m_dwFontHeight > 40 )
        m_dwTexWidth = m_dwTexHeight = 1024*2;
    else if( m_dwFontHeight > 20 )
        m_dwTexWidth = m_dwTexHeight = 512*2;
    else
        m_dwTexWidth  = m_dwTexHeight = 256*2;
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont::GetTextExtent( WCHAR* strText, SIZE* pSize )
{
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont::Render3DText( WCHAR* strText, DWORD dwFlags )
{
    if( m_pd3dDevice == NULL )
        return E_FAIL;
